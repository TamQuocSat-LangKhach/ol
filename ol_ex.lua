...
Fk:loadTranslationTable{
  ...
  ["ol_ex__huangtian"] = "黄天",
  [":ol_ex__huangtian"] = "主公技，其他群势力角色的出牌阶段限一次，该角色可以将一张【闪】或黑桃手牌交给你（正面朝上移动）。",

  ["ol_ex__huangtian_other&"] = "黄天",
  [":ol_ex__huangtian_other&"] = "出牌阶段限一次，你可将一张【闪】或黑桃手牌交给张角（正面朝上移动）。",

  ["#ol_ex__leiji-choose"] = "雷击：你可以选择一名其他角色，对其造成%arg点雷电伤害",
  ["#ol_ex__guidao-ask"] = "鬼道：可以打出一张黑色牌替换 %dest 的“%arg”判定，若打出♠2~9，你摸一张牌",
  ["#ol_ex__huangtian-active"] = "发动黄天，选择一张【闪】或黑桃手牌交给一名拥有“黄天”的角色（正面朝上移动）",
