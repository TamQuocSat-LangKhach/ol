...
Fk:loadTranslationTable{
  ...
  ["#ol_ex__jiuchi"] = "你是否想要发动“酒池”，将一张♠手牌当【酒】使用",
...
jiuchi:addEffect(fk.Damage, {
  ...
  can_trigger = function(self, event, target, player, data)
    if target == player and player:hasSkill(jiuchi.name) and data.card and data.card.trueName == "slash"
